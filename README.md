...
[![Semantic Segmentation](img/semseg/thumbnail.png)](https://youtu.be/HzW1ZUwmlTQ "Semantic Segmentation")
...
|:---------------------------------:|:---------------------------------:|
|![](img/semseg/test1.png) | ![](img/semseg/pred1.png)|
|![](img/semseg/test2.png) | ![](img/semseg/pred2.png)|
|![](img/semseg/test3.png) | ![](img/semseg/pred3.png)|
